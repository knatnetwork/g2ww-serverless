      ...
      <body class="antialiased font-sans">
          <div class="md:flex min-h-screen" style="display: flex;">
              ...
              <div class="relative pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
                  <div style="background-image: url(https://nova-moe-blog-assets.webp.se/g2ww.jpg);" class="absolute pin bg-cover bg-no-repeat md:bg-left lg:bg-center">
  </div>
              </div>
          </div>
      </body>
...
async function postWeChatUrl(request) {
  ...
  const wechat_work_url = "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=" + key
